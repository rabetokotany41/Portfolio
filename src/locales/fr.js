...
export const fr = {
  ...
  header: {
    ...
    experience: "3+ ans d'expérience" // AJOUTÉ
  },
  ...
  services: {
    ...
    list: {
      ...
      mobile: {
        ...
        description: "Développement d'applications Android avec interfaces intuitives et modernes.",
  ...
  resume: {
    ...
    stats: [
      ...
      { value: "1+", label: "Projets réalisés" },
    ...
    experience: {
      ...
      items: [
        {
          title: "Stage en développement web PHP",
          company: "Région Analamanga",
          period: "2024",
          description: "Développement de fonctionnalités web et gestion réseau dans le cadre d’un stage étudiant, avec des solutions simples, efficaces et adaptées aux besoins de l’organisation.",
          technologies: ["PHP", "MySQL"]
        },
        {
          title: "Conception et réalisation d’un système de gestion automatisée des plaintes et réclamations des citoyens",
          company: "INSI | Antananarivo",
          period: "2024 - 2025",
          description: "Développement d'une application web et mobile pour la gestion des dons et des utilisateurs, avec une interface simple, responsive et ergonomique.",
          technologies: ["React", "Flutter", "Tailwind CSS", "CSS", "Django", "PostgreSQL"]
        },
        {
          title: "Projet de site de vente en ligne (projet personnel)",
          company: "Projet Personnel",
          period: "2024 - 2025",
          description: "Création d’un site de vente en ligne interactif pour présenter des produits et fonctionnalités, avec une interface moderne, ergonomique et responsive.",
          technologies: ["React", "CSS", ".NET"]
        },
        {
          title: "Mini projet personnel",
          company: "Projet Personnel",
          period: "2024 - 2025",
          description: "Création d’un projet personnel de gestion de vente globale en ligne, avec une interface moderne et responsive.",
          technologies: ["React", "Tailwind CSS", "CSS", "Node.js", "Express", "PostgreSQL"]
        },
        {
          title: "20 projets JavaScript",
          company: "Projet",
          period: "2023 - 2024",
          description: "Création de meteo app, todo app, quiz app, calculator app, etc.",
          technologies: ["JavaScript", "HTML", "CSS"]
        },
        {
          title: "Participation à un hackathon",
          company: "Projet",
          period: "2025 - 2026",
          description: "Développement frontend et implémentation de fonctionnalités CRUD pour le projet.",
          technologies: ["React", "Tailwind CSS", "Node.js", "Express", "PostgreSQL"]
        },
        {
          title: "Projet Personnel - Application de musique",
          company: "Projet Personnel",
          period: "2025 - 2026",
          description: "Développement d’une application mobile de musique avec React Native et Expo, incluant le frontend et l’implémentation de fonctionnalités CRUD.",
...
export const en = {
  ...
  header: {
    ...
    experience: "3+ years experience" // ADDED
  },
  ...
  services: {
    ...
    list: {
      ...
      mobile: {
        ...
        description: "Development of iOS and Android applications with intuitive and modern interfaces.",
